    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#020617] text-white">
      ...
      >
        <div className="mb-8 flex items-center justify-between">
          <div>
            <p className="text-[10px] uppercase tracking-[0.45em] text-cyan-300/70">
              GitHub Analytics
            </p>
          ...
          <motion.div
            className="relative h-14 w-14 rounded-2xl border border-cyan-300/20 bg-cyan-300/5"
        ...
        <div className="grid grid-cols-3 gap-3">
          {["Fetching", "Hydrating", "Rendering"].map((item, index) => (
            ...
            >
              ...
              />
              <p className="text-xs uppercase tracking-[0.28em] text-slate-400">{item}</p>
            </motion.div>
          ))}
        </div>
      </motion.div>
